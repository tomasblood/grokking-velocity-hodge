...
# MAGIC %md
# MAGIC # Grokking 10: Three-Seed Event Study
# MAGIC
# MAGIC Inputs:
# MAGIC - Three-seed cached Grokking result roots
# MAGIC - Optional three-seed robustness summary
# MAGIC
# MAGIC Outputs:
...
# MAGIC %md
# MAGIC ## Step 1: Configure event-study inputs
...
TRANSITION_WINDOW_DELTA = (-1500.0, 1000.0)
EVENT_X_LIMITS = (-3000.0, 10000.0)
EVENT_GRID_STEP = 500.0
THRESHOLD_FOR_ALIGNMENT = 0.5
...
def _default_event_runs() -> list[dict]:
    return [
        {
            "seed": "598",
            "key": "baseline_seed598_probe42",
            "label": "seed 598",
            "root": str(ROOT),
            "activation_dir": str(GROKKING.activation_dir),
            "color": MAIN_COLOR,
        },
        {
            "seed": "599",
            "key": "seed599_probe43",
            "label": "seed 599",
            "root": "/dbfs/FileStore/thesis_scratch/grokking_three_seed_current_2026_05_10/seed599",
            "activation_dir": "/dbfs/FileStore/thesis_scratch/grokking_seed599_hodge/results/grokking_acts_v6",
            "color": ACCENT_COLOR,
        },
        {
            "seed": "777",
            "key": "seed777_probe43",
            "label": "seed 777",
            "root": "/dbfs/FileStore/thesis_scratch/grokking_three_seed_current_2026_05_10/seed777",
            "activation_dir": "/dbfs/FileStore/thesis_scratch/grokking_seed777_hodge/results/grokking_acts_v6",
...
# MAGIC %md
# MAGIC ## Step 2: Load series helpers
...
def record_series(records: list[dict], x_key: str, y_key: str, t_grok: float) -> tuple[np.ndarray, np.ndarray]:
...
def interpolate_stack(series_by_seed: dict[str, tuple[np.ndarray, np.ndarray]], grid: np.ndarray) -> np.ndarray:
    rows = []
...
# MAGIC %md
# MAGIC ## Step 3: Assemble event-study panels
...
# MAGIC %md
# MAGIC ## Step 4: Figure: fig_grokking_event_study.pdf

# COMMAND ----------

# DBTITLE 1,fig_grokking_event_study.pdf
...
def plot_panel(ax, panel: dict) -> None:
    ...
    ax.fill_between(grid[valid], mean[valid] - sd[valid], mean[valid] + sd[valid], color="#9AA0A6", alpha=0.15, lw=0)
...
# MAGIC %md
# MAGIC ## Step 5: Output: event_study_results.json

# COMMAND ----------

# DBTITLE 1,event_study_results.json
serialised_panels = {}
for panel in panels:
